...
func DeserializeBlockHeader(r io.Reader) (*types.BlockHeader, error) {
	...
	if bh.Version, err = ReadInt32(r); err != nil { return nil, err }
	
	if _, err = io.ReadFull(r, bh.PrevBlockHash[:]); err != nil { return nil, err }
	if _, err = io.ReadFull(r, bh.MerkleRoot[:]); err != nil { return nil, err }
	
	if bh.Timestamp, err = ReadUint32(r); err != nil { return nil, err }
	if bh.Bits, err = ReadUint32(r); err != nil { return nil, err }
	if bh.Nonce, err = ReadUint32(r); err != nil { return nil, err }
